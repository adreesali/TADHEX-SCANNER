...
//         <Link to="/" className="text-2xl">TADHEX Scanner</Link>
//       </div>
//       <div className="flex space-x-4 items-center"> {/* Added items-center to center align content */}
//         <Link to="/links" className="hover:text-gray-300">Links</Link>
//         <Link to="/shop" className="hover:text-gray-300">Shop</Link>
//         <Link to="/cart" className="hover:text-gray-300 relative flex items-center"> {/* Added flex and items-center for icon and text alignment */}
//           <FaShoppingCart className="text-3xl text-gray-300" /> {/* Cart icon with larger size and gray color */}
//           {cartItemCount > 0 && <span className="absolute -top-2 -right-2 bg-red-500 text-white rounded-full px-2">{cartItemCount}</span>}
//         </Link>
//       </div>
//     </nav>
//   );
